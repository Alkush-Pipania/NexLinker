...
import logo from '../assets/img/Resume builder.png';
...
const Header = () => {
  ...
  return (
    <header className="items-center w-full flex justify-between px-4 py-3 lg:px-8 border-b border-gray-300 bg-bgPrimary z-50 gap-12 sticky top-0">
      {/* logo */}
      <Link to="/" className='flex items-center gap-4 text-sm font-semibold group'>
      ...
      className="flex-1 border border-gray-300 px-4 py-1 rounded-b-md flex items-center justify-between bg-gray-100">
        <input 
       value = {filterData?.searchTerm ? filterData.searchTerm : ""}
       onChange={handleSearchTerm}
        type="text" placeholder='Search here...' className='flex-1 bg-transparent text-base outline-none h-10 bg-gray-100 border-none'/>
